 ...
 * @author 22PROGB01
 */
public class InvenatarioNino extends javax.swing.JFrame {

    /**
     * Creates new form InvenatarioNino
     */
    public InvenatarioNino() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InvenatarioNino.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InvenatarioNino().setVisible(true);
            }
        });
    }
