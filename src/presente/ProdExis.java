 ...
 * @author 22PROGB01
 */
public class ProdExis extends javax.swing.JFrame {

    /**
     * Creates new form ProdExis
     */
    public ProdExis() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdExis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
